...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-r1fplkg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-r1fplkg.containers.anotherwebservice.com/
...
```
git clone git@github.com:tk97code/Bankchecker-Backend.git
cd container-r1fplkg
```
...
```
docker attach container-r1fplkg
```
